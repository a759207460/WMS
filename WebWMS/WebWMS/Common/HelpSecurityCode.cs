       ...
       public static MemoryStream CreateCodeImg(string checkCode)
          {
                 ...
                 Bitmap image = new((int)Math.Ceiling(checkCode.Length * 12.5), 22);
                 ...
                 try
              {
                         ...
                         Font font = new("Arial", 12, (FontStyle.Bold | FontStyle.Italic));
                         System.Drawing.Drawing2D.LinearGradientBrush brush = new(new Rectangle(0, 0, image.Width, image.Height), Color.Red, Color.DarkRed, 1.2f, true);
